...
import com.nwt.recyglo_shop.RecygloApp;
...
public class ISO8601DateParser {
    ...
    public static String getFormattedDate(String date) {
        ...
        String tmp;
        try {
            d = ISO8601DateParser.parse(date);
            df = new SimpleDateFormat("d M yyyy");
            st = new StringTokenizer(df.format(d).toUpperCase());
            tmp = st.nextToken() + " " + RecygloApp.getContext().getResources().getStringArray(R.array.month_array)[Integer.parseInt(st.nextToken()) - 1] + " " + st.nextToken();
            return tmp;
    ...
    public static String getFormattedDateAndTime(String date) {
        return ISO8601DateParser.getFormattedDate(date) + " at " + ISO8601DateParser.getFormattedTime(date);
    }
